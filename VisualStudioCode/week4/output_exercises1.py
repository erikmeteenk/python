...
def exercise8():
    number = int(input("vooer getal in:"))#user gave in 10
    if number == 10:
        print("A")
    if number < 30:
        print("B")
...
def exercise14():
    ...
    for i in array:
        if isinstance(i, int): #isinstance checkt of de type van "i" gelijk is aan het meegegeven type
            print(i)
#exercise14()
